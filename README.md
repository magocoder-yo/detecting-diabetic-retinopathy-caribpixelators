...
The data used to train the model (*retinamnist_128.npz*) belongs to the MedMNIST dataset (see https://medmnist.com/), obtained from their Zenodo page (see https://zenodo.org/records/10519652/files/retinamnist_64.npz)
